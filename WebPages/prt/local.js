 ...
 * SMTP section
 */
function disableSaveSMTP(cond) {
    $("#saveSMTP").prop("disabled", cond);
    $("#applySMTP").prop("disabled", cond);
    $("#saveAndApplySMTP").prop("disabled", cond);
    $("#resetValueSMTP").prop("disabled", cond);
}

// Save parameters functions
function saveSMTP(tag) {
    var obj = {};
    obj['save'] = "1";
    ajaxSaveSMTP(obj, tag);
}

function saveAndApplySMTP(tag) {
    var obj = {};
    obj['save'] = "1";
    obj['appl'] = "1";
    ajaxSaveSMTP(obj, tag);
...
function ajaxSaveSMTP(request, tag) {

    disableSaveSMTP(true);
    showLoading(tag);
    request['smse'] = $("#smtpServer").val();
    request['smpo'] = $("#smtpPort").val();
    request['smus'] = $("#smtpUser").val();
    request['smpa'] = $("#smtpPass").val();
    request['smto'] = $("#smtpTo").val();
    request['smsu'] = $("#smtpSubject").val();
...
function resetValueSMTP() {
    cond = false;
    $("#smtpServer").prop('disabled', cond);
    $("#smtpPort").prop('disabled', cond);
    $("#smtpUser").prop('disabled', cond);
    $("#smtpPass").prop('disabled', cond);
    $("#smtpTo").prop('disabled', cond);
    $("#smtpSubject").prop('disabled', cond);
    // Load values
    $("#smtpStatus").text(smtp_status_val);
    $("#smtpServer").val(smtp_server_val);
    $("#smtpPort").val(smtp_port_val);
    $("#smtpUser").val(smtp_user_val);
    $("#smtpPass").val(smtp_pass_val);
    $("#smtpTo").val(smtp_to_val);
    $("#smtpSubject").val(smtp_subject_val);
    //edns();
    // Disable Save buttons
    disableSaveSMTP(true);
}

function showPasswordSMTP() {
    if ($("#smtpPassShow").is(":checked"))
