...
void MACInit(void)
{
	...
	MAADR1 = appConfig.ip.fields.MyMACAddr.v[0]; Nop();
	MAADR2 = appConfig.ip.fields.MyMACAddr.v[1]; Nop();
	MAADR3 = appConfig.ip.fields.MyMACAddr.v[2]; Nop();
	MAADR4 = appConfig.ip.fields.MyMACAddr.v[3]; Nop();
	MAADR5 = appConfig.ip.fields.MyMACAddr.v[4]; Nop();
	MAADR6 = appConfig.ip.fields.MyMACAddr.v[5]; Nop();
...
void MACPutHeader(MAC_ADDR *remote, BYTE type, WORD dataLen)
{
	...
	MACPutArray((BYTE*)&appConfig.ip.fields.MyMACAddr, sizeof(appConfig.ip.fields.MyMACAddr));
