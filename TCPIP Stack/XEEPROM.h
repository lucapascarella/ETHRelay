...
#include "HardwareProfile.h"
...
#if defined(EEPROM_CS_TRIS) || defined (XEEPROM_CS_TRIS)	

    #if defined (XEEPROM_CS_TRIS)

        #define XEEPROM_READ        0x01
        #define XEEPROM_WRITE       0x00
        ...
        typedef enum _XEE_RESULT {
            ...
            #define XEEPROM_PAGE_SIZE       128ul
        
            typedef DWORD XEE_ADDR;
        ...
        typedef unsigned short int XEI_ADDR;

        typedef union _XEI_ADDR_VAL {
            WORD Val;
            BYTE v[2];
        } XEI_ADDR_VAL;
    #else
